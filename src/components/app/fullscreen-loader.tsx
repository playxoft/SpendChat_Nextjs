...
/**
 * Full-screen skeleton shown over the whole app during a blocking navigation
 * (e.g. switching or creating a workspace) so the screen never looks hung.
 * Fixed and above dialogs/sheets (z-100) so it covers whatever is on screen.
 */
