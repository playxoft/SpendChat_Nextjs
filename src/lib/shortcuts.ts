...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  // "#" is the tag trigger, and the picker now exists — this entry was held
  // back until it did, because the registry is rendered verbatim into the
  // in-app cheat sheet and the public shortcuts page.
  //
